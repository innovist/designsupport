...
from .youtube_channels import router as youtube_channels_router
...
router.include_router(youtube_channels_router, prefix="/youtube-channels", tags=["youtube-channels"])
